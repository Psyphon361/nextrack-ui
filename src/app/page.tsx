      ...
      <section className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 py-16">
          {[
            ...
            <div 
              key={index} 
              className="p-6 bg-gray-800/30 rounded-xl border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 group"
            >
              <div 
          ...
          {[
            ...
            >
              <div className="flex flex-col items-center text-center h-full justify-center">
                ...
                <h3 className="text-xl font-medium mb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 group-hover:from-purple-400 group-hover:to-pink-500 transition-all duration-300">
                  {feature.title}
                </h3>
